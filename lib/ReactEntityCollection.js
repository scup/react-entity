...
var ReactEntityCollection = (function () {
  function ReactEntityCollection(data) {
    var _this = this;

    _classCallCheck(this, ReactEntityCollection);
  ...
  _createClass(ReactEntityCollection, [{
    key: 'result',
...
_lodash2['default'].each(LODASH_METHODS, function (method) {
  ReactEntityCollection.prototype[method] = function () {
    var args = _lodash2['default'].reduce(_arguments, reduceToNewItem, [undefined.items]);
    ...
    return new undefined.constructor(result);
  };
});

exports['default'] = ReactEntityCollection;
